...
export type ItemIncludeTranslation = Prisma.ItemGetPayload<{
  include: typeof itemInclude;
}>;

const recipeInclude = Prisma.validator<Prisma.RecipeInclude>()({
  item: {
    include: {
      translations: true,
    },
...
export type RecipeIncludeTranslation = Prisma.RecipeGetPayload<{
...
const App = (props: React.PropsWithChildren) => {
  ...
  const hideContribResources =
    data?.user.role !== "ADMIN" && data?.user.role !== "CONTRIBUTOR";
